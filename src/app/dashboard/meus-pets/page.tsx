    ...
    <div className={styles.container}>
      <div className={styles.topBar}>
        <div className={styles.searchWrap}>
          <img src="/lupa.svg" alt="lupa" className={styles.iconeLupa} />
          <input placeholder="Procure pet por nome" value={busca} onChange={e => setBusca(e.target.value)} />
        </div>
        <div className={styles.ordenarWrap}>
